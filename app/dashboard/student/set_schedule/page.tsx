...
// ---------- DUMMY DATA (akan diganti dengan data dari student_schedule nanti) ----------
const TIME_SLOTS = [
...
function SetScheduleContent() {
  ...
  // Tanggal dummy (Agustus 2026) - nanti akan diganti dengan data dari student_schedule
  const dates = useMemo(() => getDatesInMonth(2026, 7), [])
  const monthName = 'Agustus 2026'

  // Fetch data match berdasarkan matchId
  useEffect(() => {
    if (!matchId) {
    ...
    const fetchMatch = async () => {
      ...
      setError(null)
      try {
        // Gunakan API untuk mendapatkan detail match
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 space-y-6">
      ...
      <p className="text-muted-foreground">
        Pilih mata pelajaran dan tentukan jadwal untuk {matchData.tutor_full_name || 'tutor'}.
      </p>
