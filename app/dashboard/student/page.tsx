...
export default function StudentDashboard() {
  // 🔥 STATE TERPISAH – SAMA PERSIS DENGAN TUTOR
  ...
  // ============================================================
  // FETCH DATA – LANGSUNG DARI SUPABASE (bypass API)
  // ============================================================
  useEffect(() => {
    isMounted.current = true

    // ⏱️ TIMEOUT FALLBACK – PASTIKAN LOADING FALSE
    ...
    const loadStudentData = async (user: any) => {
      try {
        ...
        if (studentError) {
          console.error('[Dashboard] ❌ Error query students:', studentError)
          throw studentError
        }
        ...
        if (student) {
          ...
          try {
            ...
            console.warn('[Dashboard] ⚠️ Matches fetch error:', matchErr)
          }
        } else {
