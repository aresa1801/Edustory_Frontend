...
export default function StudentDashboard() {
  ...
  const [hasData, setHasData] = useState(false) // 🔥 UNTUK MEMASTIKAN LOADING BERHENTI

  // ============================================================
  // FETCH DATA – SAMA PERSIS DENGAN TUTOR
  // ============================================================
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        console.log('[StudentDashboard] 🔄 Fetching data for user:', authUser.id)
        ...
        if (student) {
          ...
          setHasData(true) // 🔥 TANDAI DATA ADA
          ...
          setHasData(true) // 🔥 TETAP TANDAI SUDAH SELESAI
        }
  ...
  // 🔥 EFEK KEDUA: MEMASTIKAN LOADING FALSE JIKA ADA DATA
  useEffect(() => {
    if (hasData && loading) {
      console.log('[StudentDashboard] 🔥 Data sudah ada, paksa loading=false')
      setLoading(false)
    }
  }, [hasData, loading])
