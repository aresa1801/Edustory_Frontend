...
import { useAuth } from '@/lib/auth-context'  // 🔥 PAKAI useAuth
import {
...
export default function StudentDashboard() {
  ...
  const fetchDashboardData = async (userId: string) => {
    ...
    try {
      ...
      // Ambil matches & offers (mirip dengan tutor)
  ...
  // ============================================================
  // useEffect – SAMA PERSIS DENGAN TUTOR (dengan timeout fallback)
  // ============================================================
  useEffect(() => {
  ...
  // ============================================================
  // LOADING / ERROR (sama seperti tutor)
  // ============================================================
  ...
  // ============================================================
  // RENDER UTAMA – sama seperti sebelumnya (stat cards, tabs, dll.)
  // ============================================================
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      {/* 🔥 DEBUG PANEL – untuk memastikan data */}
