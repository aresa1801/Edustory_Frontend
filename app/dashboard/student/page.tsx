...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    // Ambil user langsung dari supabase (tanpa useAuth)
    const fetchUserAndData = async () => {
      try {
        ...
        console.error('[StudentDashboard] Error getUser:', err)
        setError(err.message || 'Gagal mendapatkan user')
        setLoading(false)
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground flex items-center gap-1">
                ...
                <span className="truncate">Email tidak tersedia</span>
              </p>
            </div>
          </div>
