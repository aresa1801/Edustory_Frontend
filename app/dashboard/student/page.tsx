...
export default function StudentDashboard() {
  ...
  // 🔥 State untuk mode belajar (Online / Offline)
  const [isOnline, setIsOnline] = useState(true)

  // Fetch data student (sama seperti onboarding)
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        if (studentData?.id) {
          const supabase = (await import('@/lib/auth')).createClient()
