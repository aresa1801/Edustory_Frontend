...
import { useAuth } from '@/lib/auth-context'   // 🔥 SAMA SEPERTI TUTOR
import {
...
export default function StudentDashboard() {
  const { user: authUser, loading: authLoading } = useAuth()   // 🔥 SAMA SEPERTI TUTOR

  // 🔥 STATE NAMECARD – SAMA PERSIS DENGAN TUTOR (hanya ganti nama)
  ...
  // ============================================================
  // useEffect – SAMA PERSIS DENGAN TUTOR + TIMEOUT FALLBACK
  // ============================================================
  useEffect(() => {
    isMounted.current = true
    fetchDone.current = false

    // ⏱️ TIMEOUT FALLBACK – PASTIKAN DASHBOARD BISA DIBUKA
